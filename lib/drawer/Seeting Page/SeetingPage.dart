    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Row(
            children: [
              Text("Night Mode",style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400),),
                ...
                child: Switch(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      isDark ?DynamicTheme.of(context)!.setTheme(AppThemes.Dark) : DynamicTheme.of(context)!.setTheme(AppThemes.LightBlue);
                    });
