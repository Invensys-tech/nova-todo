...
//   // var partnerNames= widget.datamanager.getLoan();
...
//                 future: widget.datamanager.getLoan(), // Fetch loans dynamically
...
//                                 value ?? ''; // Ensure controller updates
//                           });
//                         },
//                       ),
...
//                                 'bankAccount': _paymentController.text,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: MediaQuery.of(context).size.height * 0.02),
              FutureBuilder<List<Loan>>(
                future: widget.datamanager.getLoan(),
                builder: (context, snapshot) {
                  Map<String, int> partnerMapping = {};
                  ...
                  if (_paidByController.text == 'Partner') {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      for (Loan loan in snapshot.data!) {
