...
class _ExpensespageState extends State<Expensespage> {
  ...
  //   String titleofExpenses,
  //   String catagoryofexpenses,
  //   String amountofexpenses,
  // ) {
  //   return
  //   Column(
  //     children: [
  ...
  //                 ? Icon(Icons.circle_rounded, size: 17, color: Colors.green)
  //                 : typeofexpenses == "MayBe Expenses"
  //                 ? Icon(Icons.circle_rounded, size: 17, color: Colors.orange)
