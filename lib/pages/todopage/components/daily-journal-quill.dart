...
class _DailyJournalQuillState extends State<DailyJournalQuill> {
  ...
  saveJournal() async {
    ...
    DailyJournalRepository().upsertFromMap(dailyJournalMap).then((value) {
      if (value) {
        widget.refetchData();
      }
    }).catchError((error) {
        ...
        actions: [
          Padding(
            ...
            child: ElevatedButton(
              ...
              // widget.journal != "" ? updateJournal : saveJournal,
              // onPressed: saveJournal,
                      ...
                      Container(
                        ...
                        child: QuillSimpleToolbar(
                          ...
                          config: QuillSimpleToolbarConfig(
                            ...
                            toolbarRunSpacing: 0,
                            showUndo: false,
                            // Set this to false to remove the undo button
                            showRedo: false,
